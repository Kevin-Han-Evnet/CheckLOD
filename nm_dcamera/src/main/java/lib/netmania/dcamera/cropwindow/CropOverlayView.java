...
package lib.netmania.dcamera.cropwindow;
...
import lib.netmania.dcamera.CropImageView;
import lib.netmania.dcamera.cropwindow.edge.Edge;
import lib.netmania.dcamera.cropwindow.handle.Handle;
import lib.netmania.dcamera.util.AspectRatioUtil;
import lib.netmania.dcamera.util.HandleUtil;
import lib.netmania.dcamera.util.PaintUtil;
...
public class CropOverlayView extends View {
    ...
    private void initCropWindow(Rect bitmapRect) {
        ...
        if (mFixAspectRatio) {
            ...
            final float horizontalPadding = 0;//0.1f * bitmapRect.width();
            final float verticalPadding = 0;//0.1f * bitmapRect.height();

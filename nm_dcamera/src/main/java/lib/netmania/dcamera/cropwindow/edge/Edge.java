...
package lib.netmania.dcamera.cropwindow.edge;
    ...
    public boolean isNewRectangleOutOfBounds(Edge edge, Rect imageRect, float aspectRatio) {
        ...
        switch (this) {
            case LEFT:
                ...
                else if (Edge.BOTTOM.equals (edge)) {
            ...
            case TOP:
                ...
                else if (Edge.RIGHT.equals (edge)) {

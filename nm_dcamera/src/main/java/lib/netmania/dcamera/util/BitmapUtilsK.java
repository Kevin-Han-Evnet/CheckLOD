...
public class BitmapUtilsK
{
	 ...
	 * @return
	 */
	public static File rotatePhotoFromFile (Context context, File file) {
		File result = file;
		...
		try {
			...
			result = BitmapUtilsK.saveBitmap (context.getApplicationContext (), file.getAbsolutePath(), Bitmap.createScaledBitmap(rotatedBitmap, width, height, false));
	 ...
	 * @return
	 */
	public static File resizePhotoFromFile (Context context, File file) {
		File result = file;
		...
		result = BitmapUtilsK.saveBitmap (context.getApplicationContext (), file.getAbsolutePath(), Bitmap.createScaledBitmap(t, width, height, false));

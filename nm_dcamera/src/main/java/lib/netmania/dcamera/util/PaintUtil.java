...
public class PaintUtil
{
	...
	private static final int DEFAULT_CORNER_COLOR = 0xFF4FC1E9;
	private static final String SEMI_TRANSPARENT = "#AA4FC1E9";
	...
	private static final float DEFAULT_GUIDELINE_THICKNESS_PX = 0;
	...
	public static Paint newBorderPaint(Context context)
	{
		...
		final float lineThicknessPx = TypedValue.applyDimension(TypedValue.COMPLEX_UNIT_DIP, DEFAULT_LINE_THICKNESS_DP, context.getResources()
				.getDisplayMetrics());
	...
	public static Paint newCornerPaint(Context context)
	{
		...
		// Set the line thickness for the crop window border.
		final float lineThicknessPx = TypedValue.applyDimension(TypedValue.COMPLEX_UNIT_DIP, DEFAULT_CORNER_THICKNESS_DP, context.getResources()
				.getDisplayMetrics());

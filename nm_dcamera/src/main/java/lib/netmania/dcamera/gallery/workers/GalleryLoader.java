...
public class GalleryLoader extends AsyncTask<Long, Object, Bitmap> {
	...
	protected Bitmap doInBackground(Long... params) {
		...
		//if(mBitmapDrawable == null){
			...
			if(mImageType.equals(DGallery.IMAGES))
			...
			DLog.e("TAG", mPath);
			resultBitmap = BitmapUtils.rotateBitmap(resultBitmap, ExifUtils.getExifOrientation(mPath));
	...
	public static class AsyncDrawable extends BitmapDrawable
	{
		...
		{
			super(res, bitmap);
			galleryLoaderReference = new WeakReference<GalleryLoader>(galleryLoader);
		}

...
public class BeaconListAdapterForJob extends BeaconItemListAdapter {
    ...
    public View getView (final int position, View convertView, ViewGroup parent) {
        ...
        if (convertView == null) {
            ...
            holder.item_hum = (TextView) convertView.findViewById(R.id.item_hum);
        ...
        if (!hasProbeTemp && item.delivery_step > BeaconItemDto.DELEVERY_STEP_READY) {
            item.temp_probe = item.temp_chipset;
            item.hum_probe = item.hum_chipset;
        }
        /** 프루브 측정이 안될 경우 칩셋온도로 고고싱!!!! ---------------------------------------------------------------------------------------------------- */
        ...
        if (item.delivery_step > BeaconItemDto.DELEVERY_STEP_READY
                ...
                item.hum_probe =Constants.NO_DATA;
        }
        ...
        holder.item_hum.setText(String.format(getContext().getResources().getString(R.string.item_beacon_humidity_info), item.hum_probe + "%"));
        ...
        switch (item.$status) {
            ...
            case BeaconItemDto.STATUS_CAUTION :
                holder.item_info_container.setBackgroundResource(com.netmania.checklod.org.R.drawable.anim_caution);
            ...
            case BeaconItemDto.STATUS_EMERGNECY :
                holder.item_info_container.setBackgroundResource(com.netmania.checklod.org.R.drawable.anim_emergency);
                holder.item_temp_probe.setTextColor(mContext.getResources().getColor(R.color.white));
                holder.item_temp_char.setTextColor(mActivity.getResources().getColor(R.color.white));
    ...
    public class ViewHolder extends BeaconItemListAdapter.ViewHolder {
        ...
        public TextView item_sticker, item_temperature_rage, item_temp_char, item_seq, item_max_temperature, item_min_temperature, item_timestamp, item_hum;

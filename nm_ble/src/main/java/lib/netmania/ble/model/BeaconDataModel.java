 ...
 *   04-04 22:40:23.843 4440-4440/? D/TksBeacon: RAW Len = 62
	 ...
	 00000000 : 0000
 */
public class BeaconDataModel implements Serializable
{
	public static final String LOG_TAG = "TksBeacon";

	// AD2 User Type ADV
	public static final int PROTOCOL_OFFSET 	= 	3;

	// define ble becon logger item size
	public static final int BCN_AD_LENGTH_SIZE	= 	1;
	public static final int BCN_AD_TYPE_SIZE	= 	1;
	public static final int BCN_COMPANY_ID_SIZE=	2;
	public static final int BCN_UBEACON_ID_SIZE=	2;
	public static final int BCN_MODE_SIZE		= 	1;
	public static final int BCN_LOG_TIME_SIZE	=	6;
	public static final int BCN_SEQ_SIZE		=	2;
	public static final int BCN_IN_TEMP_SIZE	=	2;
	public static final int BCN_IN_RH_SIZE		=	2;
	public static final int BCN_EX_TEMP_SIZE	=	2;
	public static final int BCN_EX_RH_SIZE		=	2;
	public static final int BCN_RESERVED_SIZE	=	2;
	public static final int BLE_BAT_SIZE		=	1;
	public static final int BLE_TXPWR_SIZE		=	1;

	// define becon item ptr
	public static final int BCN_AD_LENGTH_PTR	= 3;
	public static final int BCN_AD_TYPE_PTR		= 4;
	public static final int BCN_COMPANY_ID_PTR	= 5;
	public static final int BCN_UBEACON_ID_PTR	= 7;
	public static final int BCN_MODE_PTR		= 9;
	...
	public static final int BCN_SEQ_PTR			= 16;
	public static final int BCN_IN_TEMP_PTR		= 18;
	...
	public static final int BCN_RESERVED_PTR	= 26;
	...
	{
		byte[] bytes = {adv[bcnSeqPtr], adv[bcnSeqPtr+1]};
		short s = ByteBuffer.wrap(bytes).order(ByteOrder.LITTLE_ENDIAN).getShort();
	 ...
	 */
	public static void updateFrom(BeaconDataModel bcn, int rssi, final byte[] adv)
	{
		// UHF User Data
		// LogUtil.D(LOG_TAG, "ud:" + String.format("%02X %02X", adv[BCN_UHF_UD_PTR],adv[BCN_UHF_UD_PTR+1] ));

		bcn.bSeq = adv[BCN_SEQ_PTR];
		bcn.beaconSeq = String.valueOf (convertSeq (adv, BCN_SEQ_PTR));

		// if miss &0xff then signed
		// below was not cnvt -signed value
		//int iTemp  = ( (adv[BCN_IN_TEMP_PTR+1]&0xFF) << 8) | (adv[BCN_IN_TEMP_PTR] & 0xFF);

		//byte[] bytes = {adv[BCN_IN_TEMP_PTR], adv[BCN_IN_TEMP_PTR+1]};
		/*byte[] bytes = {adv[BCN_EX_TEMP_PTR], adv[BCN_EX_TEMP_PTR+1]};
		short s = ByteBuffer.wrap(bytes).order(ByteOrder.LITTLE_ENDIAN).getShort();

		int iTemp = (int)s;
		bcn.dTemp = (double)(iTemp/10.0);*/
						...
						final byte[] adv)
	{
		...
		*/
		...
		this.cntPastAway = 0;
		this.idMacAddr = (device != null) ? device.getAddress() : "00:00:00:00:00:00";
